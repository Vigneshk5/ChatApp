...
export default function Chat() {
  ...
  function connectToWs() {
    const ws = new WebSocket("wss://chatapi1-uzmt.onrender.com");
    setWs(ws);
      ...
      <div className="flex flex-col bg-indigo-50 w-2/3 p-2">
        ...
        {!!selectedUserId && (
          <form className="flex gap-2 " onSubmit={sendMessage}>
            ...
            />
            <label className="bg-indigo-200 p-2 rounded-md text-gray-600 cursor-pointer border border-indigo-200">
            ...
            <button type="submit" className="bg-indigo-500 p-2 rounded-md text-white">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
